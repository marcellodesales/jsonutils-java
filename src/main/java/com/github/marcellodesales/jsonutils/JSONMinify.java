package com.github.marcellodesales.jsonutils;

/**
 * Minifies a given JSON string compatible with
 * http://beautifytools.com/json-minifier.php
 * and probably the only functional version.
 * 
  ...
  public static String minify(String jsonString) {
    ...
    for (int i = 0; i < jsonString.length(); i++) {
      ...
      if (in_string) {
        ...
        // we're outside of the special modes, so look for mode openers (comment start, string
        // start)
        if (cc.equals("/*")) {
